...
Build or refine `PROJECT-CONTEXT.md` through a guided interview.
...
After gathering all inputs, synthesize and present a draft for user confirmation, then write the final `PROJECT-CONTEXT.md`.
