# GitHub Terminology Cheat Sheet — Session 1

> **Keep this!** Refer to it anytime you need a quick reminder of what a GitHub term means.
> Farm analogies are in *italics*.

---

## Terms You Learned Today

| # | GitHub Term | Farm Analogy | What It Means |
|---|-----------|-------------|---------------|
| 1 | **Repository** (repo) | *Your digital barn* | A container on GitHub that holds all your files, folders, and history for one project |
...
| Task | Steps |
|------|-------|
| **Find a file in a repository** | Click the file name in the file list |
| **Open a folder** | Click the folder name |
| **Go back to the main page** | Click the repository name at the top |
| **Read the README** | Scroll down on the repository main page — it's displayed automatically |
| **Zoom in on small text** | Press `Ctrl` + `+` (Windows) or `Cmd` + `+` (Mac) |
| **Zoom out** | Press `Ctrl` + `-` (Windows) or `Cmd` + `-` (Mac) |
| **Go to your profile** | Click your profile picture (top right) → "Your profile" |
| **Go to your dashboard** | Click the GitHub logo (top left) |
| **Search for something** | Click the search bar at the top, type your search, press Enter |
| **Log out** | Click your profile picture (top right) → "Sign out" |

---

## Coming in Future Sessions

These terms will make more sense later — no need to learn them now!
...
| Pull Request | Sharing your harvest plan for approval | Session 4 |
| Fork | Making your own copy of a shared plan | Session 4 |
| Notification | Farm radio alert | Session 5 |
| Action | Automatic farm helper | Session 7 |

---

*Print this page and keep it near your computer. You'll add to it each session!*
