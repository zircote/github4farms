...
async function buildSession3Slides() {
  const pptx = new pptxgen();
  pptx.layout = "LAYOUT_16x9";
  pptx.author = "GitHub4Farms Training";
  pptx.title = "Session 3: GitHub Projects for Planning";
  pptx.subject = "GitHub Training for Farmers — Session 3 of 12";
