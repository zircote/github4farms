...
async function buildSession2Slides() {
  const pptx = new pptxgen();
  pptx.layout = "LAYOUT_16x9";
  pptx.author = "GitHub4Farms Training";
  pptx.title = "Session 2: GitHub Issues for Task Tracking";
  pptx.subject = "GitHub Training for Farmers — Session 2 of 12";
